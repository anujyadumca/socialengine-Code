...
<div class="group_discussions_options">
  <?php echo $this->htmlLink(array('route' => 'company_profile', 'id' => $this->group->getIdentity(), 'slug' => $this->group->getSlug()), $this->translate('Back to Company'), array(
    'class' => 'buttonlink icon_back'
  )) ?>
  <?php
    if ($this->can_post)
    {
      echo $this->htmlLink(array('route' => 'company_extended', 'controller' => 'topic', 'action' => 'create', 'subject' => $this->group->getGuid()), $this->translate('Post New Topic'), array(

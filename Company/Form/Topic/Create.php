 ...
 * @license    http://www.socialengine.com/license/
 */
class Company_Form_Topic_Create extends Engine_Form
{
  public function init()
  {
    ...
    $allowHtml = (bool) $settings->getSetting('company_html', 0);
    $allowBbcode = (bool) $settings->getSetting('company_bbcode', 0);
    ...
    if( $allowHtml || $allowBbcode ) {
      ...
      if( Engine_Api::_()->authorization()->isAllowed('album', $viewer, 'create') ) {
        $uploadUrl = Zend_Controller_Front::getInstance()->getRouter()->assemble(array('controller'=>'index', 'action'=>'upload-photo'), 'company_extended', true);

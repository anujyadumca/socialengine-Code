 ...
 * @license    http://www.socialengine.com/license/
 */
class Company_Form_HR_Create extends Engine_Form
{
    public function init()
    {
        ...
        $this
        ->setTitle('Create New Business HR');
        ...
        $this->addElement('Radio', 'hrtype', array(
            'label' => 'Key People',
            'multiOptions' => array(
                '1' => 'Chairman',
                '2' => 'President',
                '3' => 'Chief Finacial Officer',

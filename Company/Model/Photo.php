 ...
 * @license    http://www.socialengine.com/license/
 */
class Company_Model_Photo extends Core_Model_Item_Collectible
{
  protected $_parent_type = 'company_album';

  protected $_owner_type = 'user';

  protected $_collection_type = 'company_album';
  ...
  {
    return Engine_Api::_()->getItem('company', $this->group_id);

...
{
  protected $_parent_type = 'company_group';

  protected $_owner_type = 'user';

  protected $_children_types = array('company_post');
  ...
  {
    return Engine_Api::_()->getItem('company_group', $this->group_id);
  }
  ...
  {
    $table = Engine_Api::_()->getItemTable('company_post');
    $select = $table->select()
      ->where('topic_id = ?', $this->getIdentity())
      ->order('post_id DESC')
      ->limit(1);
  ...
  protected function _delete()
  {
    ...
    $postTable = Engine_Api::_()->getItemTable('company_post');

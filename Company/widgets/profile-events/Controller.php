 ...
 * @license    http://www.socialengine.com/license/
 */
class Company_Widget_ProfileEventsController extends Engine_Content_Widget_Abstract
{
  ...
  public function indexAction()
  {
  	...
  	$log->log("Step1_ProfileEvents:::",Zend_Log::DEBUG);
    ...
    $log->log("Step2_ProfileEvents:::",Zend_Log::DEBUG);
    ...
    $log->log("Step1_ProfileEvents_PaginatorCount:::".$paginator->getTotalItemCount(),Zend_Log::DEBUG);

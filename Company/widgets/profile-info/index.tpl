...
<h3><?php echo $this->translate("Company Info") ?></h3>
...
<ul>
  <li class="group_stats_title">
    ...
    <?php if( !empty($this->group->category_id) && 
      ...
      <?php echo $this->htmlLink(array('route' => 'company_general', 'action' => 'browse', 'category_id' => $this->group->category_id), $this->translate((string)$category->title)) ?>
    <?php endif; ?>
  </li>

 ...
 * @license    http://www.socialengine.com/license/
 */
class Company_Widget_BrowseSearchController extends Engine_Content_Widget_Abstract
{
	public function indexAction()
	{
		...
		// Form
		if ( $request->getModuleName() == 'company' && $request->getControllerName() == 'index' && $request->getActionName() == 'manage' ) {
			$this->view->form = $formFilter = new Company_Form_Filter_Manage();
			$defaultValues = $formFilter->getValues();
		} else {
			$this->view->form = $formFilter = new Company_Form_Filter_Browse();
			$defaultValues = $formFilter->getValues();
